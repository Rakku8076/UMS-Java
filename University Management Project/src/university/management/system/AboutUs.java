...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : Melvin Benny");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 200, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Roll Number - 03115602718");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Developed By : Rakshit Kumar");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l8.setBounds(70, 320, 600, 35);
            contentPane.add(l8);
            
            JLabel lb = new JLabel("Roll Number - 04715602718");
            lb.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            lb.setBounds(70, 380, 600, 34);
            contentPane.add(lb);

            JLabel l9 = new JLabel("Education - B.Tech (Computer Science)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 440, 600, 34);
            contentPane.add(l9);
